...
@interface OffersAndDealsViewController ()

@end

@implementation OffersAndDealsViewController
...
- (void)viewDidLoad
{
    ...
    ASIFormDataRequest *request = [ASIFormDataRequest requestWithURL:[NSURL URLWithString:@"http://68.169.52.119/Dealsinfo.json"]];
    //[request setRequestMethod:@"GET"];
    [request setDelegate:self];
    [request startAsynchronous];
    MBProgressHUD *hud = [MBProgressHUD showHUDAddedTo:self.view animated:YES];
    hud.labelText = @"Loading Offers and Deals...";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *html=[[dealsArray objectAtIndex:indexPath.section] objectForKey:@"deal"];
