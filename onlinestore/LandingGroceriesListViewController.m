//
//  LandingGroceriesListViewController.m
//  onlinestore
//
...
@interface LandingGroceriesListViewController ()

@end

@implementation LandingGroceriesListViewController
...
- (void)viewDidLoad
{
    ...
    NSString *urlString=[NSString stringWithFormat:@"http://68.169.52.119/Fetchgrocessorylstbyid/454545"];
