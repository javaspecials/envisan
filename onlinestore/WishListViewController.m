...
- (IBAction)browseBtnTapp:(id)sender {
    WishDisplayViewController *wishDisplay = [self.storyboard instantiateViewControllerWithIdentifier:@"WishDisplayViewController"];
    [self presentViewController:wishDisplay animated:YES completion:nil];
}
