//
//  GroceriesDisplayViewController.h
//  onlinestore
//
...
@interface GroceriesDisplayViewController : UIViewController<UITableViewDataSource,UITableViewDelegate,UISearchDisplayDelegate>
{
