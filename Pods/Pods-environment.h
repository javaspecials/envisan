...
// BlueCatsSDK
#define COCOAPODS_POD_AVAILABLE_BlueCatsSDK
#define COCOAPODS_VERSION_MAJOR_BlueCatsSDK 0
#define COCOAPODS_VERSION_MINOR_BlueCatsSDK 1
#define COCOAPODS_VERSION_PATCH_BlueCatsSDK 2
